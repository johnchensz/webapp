...
import cn.jcb.dev.spittr.data.SpitterNotFoundException;
...
public class SpitterController {
	...
	public String processRegistration(@Valid Spitter unsaveSpitter, RedirectAttributes model, Errors errors) 
